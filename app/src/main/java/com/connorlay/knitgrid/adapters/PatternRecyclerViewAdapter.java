 ...
 */
public class PatternRecyclerViewAdapter extends RecyclerView.Adapter<PatternRecyclerViewAdapter.PatternViewHolder> {
    ...
    public void onBindViewHolder(final PatternViewHolder holder, int position) {
        ...
        holder.dimensionTextView.setText(String.format("%s x %s", pattern.getRows(), pattern.getColumns()));
